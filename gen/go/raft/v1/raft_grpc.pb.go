...
const (
	...
	RaftService_RequestVoteReply_FullMethodName   = "/raft.v1.RaftService/RequestVoteReply"
	RaftService_AppendEntries_FullMethodName      = "/raft.v1.RaftService/AppendEntries"
	RaftService_AppendEntriesReply_FullMethodName = "/raft.v1.RaftService/AppendEntriesReply"
	...
	RaftService_Get_FullMethodName                = "/raft.v1.RaftService/Get"
)
...
type RaftServiceClient interface {
	RequestVote(ctx context.Context, in *RequestVoteRequest, opts ...grpc.CallOption) (*Empty, error)
	RequestVoteReply(ctx context.Context, in *RequestVoteResponse, opts ...grpc.CallOption) (*Empty, error)
	AppendEntries(ctx context.Context, in *AppendEntriesRequest, opts ...grpc.CallOption) (*Empty, error)
	AppendEntriesReply(ctx context.Context, in *AppendEntriesResponse, opts ...grpc.CallOption) (*Empty, error)
...
func (c *raftServiceClient) RequestVote(ctx context.Context, in *RequestVoteRequest, opts ...grpc.CallOption) (*Empty, error) {
...
func (c *raftServiceClient) RequestVoteReply(ctx context.Context, in *RequestVoteResponse, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, RaftService_RequestVoteReply_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *raftServiceClient) AppendEntries(ctx context.Context, in *AppendEntriesRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
func (c *raftServiceClient) AppendEntriesReply(ctx context.Context, in *AppendEntriesResponse, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, RaftService_AppendEntriesReply_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *raftServiceClient) Submit(ctx context.Context, in *SubmitRequest, opts ...grpc.CallOption) (*SubmitResponse, error) {
	...
	err := c.cc.Invoke(ctx, RaftService_Submit_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RaftServiceServer interface {
	RequestVote(context.Context, *RequestVoteRequest) (*Empty, error)
	RequestVoteReply(context.Context, *RequestVoteResponse) (*Empty, error)
	AppendEntries(context.Context, *AppendEntriesRequest) (*Empty, error)
	AppendEntriesReply(context.Context, *AppendEntriesResponse) (*Empty, error)
...
func (UnimplementedRaftServiceServer) RequestVote(context.Context, *RequestVoteRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method RequestVote not implemented")
}
func (UnimplementedRaftServiceServer) RequestVoteReply(context.Context, *RequestVoteResponse) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method RequestVoteReply not implemented")
}
func (UnimplementedRaftServiceServer) AppendEntries(context.Context, *AppendEntriesRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method AppendEntries not implemented")
}
func (UnimplementedRaftServiceServer) AppendEntriesReply(context.Context, *AppendEntriesResponse) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method AppendEntriesReply not implemented")
}
...
func _RaftService_RequestVoteReply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestVoteResponse)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RaftServiceServer).RequestVoteReply(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RaftService_RequestVoteReply_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftServiceServer).RequestVoteReply(ctx, req.(*RequestVoteResponse))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RaftService_AppendEntriesReply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AppendEntriesResponse)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RaftServiceServer).AppendEntriesReply(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RaftService_AppendEntriesReply_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftServiceServer).AppendEntriesReply(ctx, req.(*AppendEntriesResponse))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RaftService_Submit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RaftService_Submit_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var RaftService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RequestVoteReply",
			Handler:    _RaftService_RequestVoteReply_Handler,
		},
		{
		...
		{
			MethodName: "AppendEntriesReply",
			Handler:    _RaftService_AppendEntriesReply_Handler,
		},
		{
